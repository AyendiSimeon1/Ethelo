        ...
        <section className="p-6 bg-gray-50 mb-8 mx-8 rounded-lg mt-8">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {allProjects.map((project: Project) => (
                    <div
                        key={project.id}
                        className={`bg-gray-400 p-6 rounded-lg shadow-md transform transition duration-200 hover:scale-105`}
                    >
                        ...
                        <p className="text-sm text-gray-700 font-mono">{project.organizationName}</p>
